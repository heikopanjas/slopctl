...
impl TemplateManager
{
    ...
    pub fn update(&self, options: &template_engine::UpdateOptions) -> Result<()>
    {
        ...
        {
            | 1 => Err(anyhow::anyhow!(
                "V1 templates are no longer supported. Migrate to V5: slopctl config --set templates.uri https://github.com/heikopanjas/slopctl-templates/tree/main/templates"
            )),
            | 2..=5 =>
            {
