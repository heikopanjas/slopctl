...
Run `vibe-cop templates --update` to download the latest global templates, then `vibe-cop install` to apply to your project.
...
Last updated: April 10, 2026 (v12.3.4)
